...
<head>
    ...
    <title>ESP | Admin | Athletes</title>
    <!-- Favourites icon -->
    ...
    <section id="main" class="section bg-light">
        ...
        <div class="container">
            <div class="grid-choice">
                <div class="polaroid">
                    <a href="newathlete.php"><img src="images/add.png" alt="Add New Athlete"></a>
                ...
                <?php
                        ...
                        echo '<a href="editathlete.php?id=' . $row['athleteID'] . '"><img src="' . $row['athleteImg'] . '" alt="' . $row['athleteFirstName'] . $row['athleteSurname'] . '"></a>' . "\r\n";
                        echo '<div class="polaroidtext">';
                        echo '<p>' . $row['athleteFirstName'] . ' ' . $row['athleteLastName'] . '</p>';
                        echo '</div>' . "\r\n" . '</div>';
                    ?>
                <?php
                        }
                    ?>
                <div class="polaroid">
                    <a href="deleteathlete.php"><img src="images/delete.png" alt="Delete Athlete"></a>
                    <div class="polaroidtext">
                        <p>Click to Delete</p>
                        <p>Athlete</p>
                    </div>
