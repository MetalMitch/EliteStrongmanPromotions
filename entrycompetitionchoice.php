...
<head>
    ...
    <title>ESP | Admin | Competitions</title>
    <!-- Favourites icon -->
    ...
    <section id="main" class="section bg-light">
        ...
        <div class="container">
            <div class="grid-choice">
                <div class="polaroid">
                    <a href="newcompetition.php"><img src="images/add.png" alt="Add New Competition"></a>
                ...
                <?php
                        ...
                        echo '<a href="editcompetition.php?id=' . $row['competitionID'] . '"><img src="' . $row['competitionImg'] . '" alt="' . $row['competitionTitle'] . '"></a>' . "\r\n";
                ...
                <?php
                    ...
                    ?>
                <div class="polaroid">
                    <a href="deletecompetition.php"><img src="images/delete.png" alt="Delete Competition"></a>
                    <div class="polaroidtext">
                        <p>Click to Delete</p>
                        <p>Competition</p>
                    </div>
