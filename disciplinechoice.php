...
<head>
    ...
    <title>ESP | Elite Disciplines</title>
    <!-- Favourites icon -->
        ...
        <div class="container">
            <div class="grid-choice">
                ...
                <?php
                        ...
                        echo '<a href="discipline.php?id=' . $row['disciplineID'] . '"><img src="' . $row['disciplineImg'] . '" alt="' . $row['disciplineFirstName'] . " " . $row['disciplineLastName'] . '"></a>' . "\r\n";
                        echo '<div class="polaroidtext">';
                        echo '<p>' . $row['disciplineName'] . '</p>';
                        echo '<p>' . $row['disciplineShortDesc'] . '</p>';
                        echo '</div>' . "\r\n" . '</div>';
                    ?>
                <?php
                        }
