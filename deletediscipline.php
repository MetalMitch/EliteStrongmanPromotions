...
if (isset($_POST['submit']))
{
    ...
    $query = "DELETE FROM tblDiscipline WHERE disciplineID = '$disciplineID'";
...
<body>
    ...
    <section id="form" class="bg-light" style="padding-top:1rem">
        <form action="#" method="post" class="entryform">
            <ul>
                  <li>
                <Label for="disciplineID[]">Article Title</label>
                <select name="disciplineID[]">
                  ...
                  <?php
                        ...
                        echo '<option value="' . $row['disciplineID'] . '">' . $row['disciplineName'] . '</option>' . "\r\n";
                    ?>
                    <?php
                        }
                    ?>
