...
<body>
    ...
    <?php
        ...
        if ($i % 2 == 0) {
            ...
            echo '<strong>' . $row['articleTitle'] . '</strong>';
            echo '</h2>';
            echo '<p>By ' . $row['articleAuthor'] . ' @ ' . $row['articleDateTime'] . '</p>';
            echo '<p><a href="article.php?id=' . $row['articleID'] . '">View Post</a></p>';
            echo '</div>';
            echo '</section>';
    ?>
    <?php
